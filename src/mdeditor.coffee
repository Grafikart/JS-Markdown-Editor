((root, factory) ->
    if typeof define is 'function' and define.amd
        define(['jquery', 'underscore', 'marked', 'codemirror', 'dropzone'], factory)
    else if typeof exports is 'object'
        module.exports = factory(require('jquery'), require('underscore'), require('marked'), require('codemirror'), require('dropzone'))
    else
        root.returnExports = factory(root.jquery, root.underscore, root.marked, root.codemirror, root.dropzone)

)(this, ($, _, marked, CodeMirror, Dropzone) ->
